...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* Chat list */}
      <div className="flex-1 overflow-y-auto mt-4 px-[30px]">
        {groups.map((group) => (
          <div key={group.label} className="mb-2">
            <p className="text-[#B8B8C0] text-xs font-semibold mb-2">
              {group.label}
            </p>
            ...
            <div className="flex flex-col gap-0.5">
              {group.chats.map((chat) => (
                <button
                  ...
                  className={cn(
                    "w-full text-left px-4 py-[9px] rounded-lg text-sm font-normal text-white transition-colors truncate",
